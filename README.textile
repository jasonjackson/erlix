...
* features:
** Type auto-convert[1]
** ErlixTuple[...] and ErlixList[...] [2]

h4. erlix-v0.3 changlog:
...
fn1. Some Ruby-Type var can be auto-convert to particular Erlang-Type:
<pre><code>
/*
...
<pre><code>
irb(main):010:0> c=ErlixList.new(["string-to-atom",1,:symbol_to_atom,1.00])
=> #<ErlixList:0xb7c33220>
irb(main):011:0> c.puts
['string-to-atom',1,symbol_to_atom,1.000000]
=> nil
irb(main):012:0> c.head.class
=> ErlixAtom
irb(main):013:0>
</code></pre>

fn2. Use singleton method [] to create ErlixTuple/ErlixList
<pre><code>
irb(main):015:0> c=ErlixList["string-to-atom",1,:symbol_to_atom,1.00]
=> #<ErlixList:0xb7c1e884>
irb(main):016:0> t=ErlixTuple["string-to-atom",1,:symbol_to_atom,1.00]
=> #<ErlixTuple:0xb7c1a414>
irb(main):017:0> t[3]
=> symbol_to_atom
